...
>(({ className, ...props }, ref) => (
  <div className="absolute left-0 right-0 top-full z-[100] flex justify-start px-0 sm:px-1">
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-left relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-[var(--radix-navigation-menu-viewport-width)] max-w-[min(100vw-1.5rem,52rem)] overflow-visible rounded-md border bg-popover text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90",
        className,
      )}
      ref={ref}
      {...props}
