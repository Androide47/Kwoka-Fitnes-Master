    ...
    <Card className="bg-card/80">
      ...
      <CardContent className="space-y-4 text-sm text-muted-foreground">
        <p>
          ...
          new clients, messages, upcoming sessions, booking requests), Workouts (create & assign),
          Library (edit/delete exercises, workouts, routines), Calendar, Chat, Blog, Settings, and
          About.
        </p>
        <p>
