    ...
    <Card className="bg-card/80">
      ...
      <CardContent className="space-y-4 text-sm text-muted-foreground">
        <p>
          ...
          new clients, messages, upcoming sessions, booking requests), Workouts (select client, set
          routine, add workout with YouTube + instructions), Calendar, Chat, Blog, Settings, and
          About.
        </p>
        <p>
