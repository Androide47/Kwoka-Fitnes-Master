...
export const mockMessages: Message[] = [
  ...
  },
  {
    ...
    senderId: 'client-1',
    receiverId: 'trainer-1',
    content: 'Could we tweak tomorrow’s session? My shoulder is still a bit tight.',
  ...
  },
  {
    ...
    senderId: 'client-2',
    receiverId: 'trainer-1',
    content: 'Uploaded new progress photos — ready when you are!',
  ...
  },
  {
    ...
    senderId: 'client-3',
    receiverId: 'trainer-1',
    content: 'Flexibility is improving. Can we add another mobility block this week?',
